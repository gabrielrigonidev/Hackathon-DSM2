...
public class Aluno extends Pessoa{
   ...
   public Aluno(Scanner entrada, String nome, String cpf, int idade, int mes_atual, int qtd_desejada_livro, String nm_livro_desejado, int mes_devolucao, int qtd_ficou, int mes_desejado) {
